...
[![My Skills](https://skillicons.dev/icons?i=python,cpp,cs,js,html,css,dart)](https://skillicons.dev)
...
But, more recently, I started learning **Dart** *(from Google)* with **Flutter** with the goal of retrying to programm OneLesson.

My journey as a dev is quite unusual, but it helped me to learn lots of programming languages and frameworks.

## My workflow

[![My Workflow](https://skillicons.dev/icons?i=vscode,github,figma,notion,stackoverflow,nodejs,godot,unity,visualstudio,flutter)](https://skillicons.dev)
